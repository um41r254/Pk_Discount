...
public class FragShoe1 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvShoe1 = view.findViewById(R.id.recycler_shoe_1);
    ...
    private void getData(String style, String size) {
        ...
        query.get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    rvShoe1.setAdapter(adapter);
                    rvShoe1.setLayoutManager(new GridLayoutManager(getContext(), 2));
