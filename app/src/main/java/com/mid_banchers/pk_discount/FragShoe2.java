...
public class FragShoe2 extends Fragment {

    FirebaseFirestore db = FirebaseFirestore.getInstance();
    List<DataModel> data = new ArrayList<>();
    RecyclerView rvShoe2;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvShoe2 = view.findViewById(R.id.recycler_shoe_1);
    ...
    private void getData(String style, String size) {
        ...
        query.get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    rvShoe2.setAdapter(adapter);
                    rvShoe2.setLayoutManager(new GridLayoutManager(getContext(), 2));
